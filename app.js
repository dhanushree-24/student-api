...
// Serve static files (Blue.jpg, IAS.png, etc.)
    ...
    <header id="top">
        <table width="100%" bgcolor="#222222" cellpadding="15" cellspacing="0" border="0">
            <tr>
                <td>
                    <font color="#ffffff">
                        <strong>Union Public Service Commission</strong>
                    </font>
                </td>
                <td align="right">
    ...
    <main>
        ...
        <p align="center">
            <font color="#ffffff" size="4" face="Arial">
                Serving the people of India with excellence.
            </font>
        </p>
            ...
            <tr>
                <td>
                    ...
                    <section id="home">
                        ...
                        <p>
                            The journey to become an IAS officer begins with a passion
                            for public service and a commitment to excellence.
                        </p>

                        <br>

                        <div align="center">
                            <img src="/IAS.png" alt="IAS Officer" width="540" border="1">
                            <br><br>

                            <p>
                                <strong>Fig 1.1</strong>:
                                <i>
                                    Serving the people of India as an IAS officer
                    ...
                    <section id="about">
                        ...
                        <p>
                            We document a vision of computing technology integrated
                            with public service excellence.
                        </p>

                        <p>
                            Innovation is meaningful when it serves people.
                            Our goal is to bridge the gap between technology
                            and everyday public needs.
                        </p>
    ...
    <footer>
        <table width="100%" bgcolor="#222222" cellpadding="15" cellspacing="0" border="0">
            <tr>
                <td align="center">
                    <font color="#ffffff">
                        &copy; 2026 Empowering citizens. Inspiring change.
                    </font>
                </td>
            </tr>
        </table>
